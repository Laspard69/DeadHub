...
local Tabs = {
    ...
    Credits = Window:AddTab({ Title = "Credits", Icon = "file-minus"})
}

Tabs.Combat:AddParagraph({
    Title = "Work-In-Progress",
    Content = "The devs are working in this tab, Please be PATIENT!"
})

Tabs.Main:AddButton({
    Title = "Auto Bonds",
    Description = "Automatically Farm Bonds!",
    Callback = function ()
        pcall(function()
...
Tabs.Credits:AddParagraph({
    Title = "Made by Laspard/Laspynx69",
    Content = "Developers are Working in this PROJECT!"
})
